...
import { Home, User, Briefcase } from 'lucide-react'; // Menggunakan ikon dari lucide-react
...
export default function Navbar({ currentPage, onNavigate }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white shadow-lg border-t border-gray-200 md:top-0 md:bottom-auto md:h-16">
      <div className="max-w-4xl mx-auto h-full flex justify-around items-center px-4">
        {/* Tampilan Desktop (atas) */}
